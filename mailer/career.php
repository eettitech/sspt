...
$cname = preg_replace('/[^-a-zA-Z0-9_ ]/', '', $_POST['cname']);
$cphone= preg_replace('/[^-a-zA-Z0-9_ ]/', '', $_POST['cphone']);
$cemail = preg_replace('/[^-a-zA-Z0-9_@.]/', '', $_POST['cemail']);
$rta = preg_replace('/[^-a-zA-Z0-9_ ]/', '', $_POST['rta']);
$caddress = preg_replace('/[^-a-zA-Z0-9_ ]/', '', $_POST['caddress']);
$cdesc = preg_replace('/[^-a-zA-Z0-9_ ]/', '', $_POST['cdesc']);
...
try {
    ...
    $ct = nl2br("Fullname: {$cname} \r\n Phone: {$cphone} \r\n Email: {$cemail} \r\n Role To Apply: {$rta} \r\n Address: {$caddress} \r\n Decription: {$cdesc}");

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = "Career Form - {$cname} - {$cphone}";
    $mail->Body    = '<h4>'.$ct.'</h4>';
    ...
    $mail->addAddress($cemail, $cname); // Add a recipient address
